  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden dm:flex items-center gap-6 lg:gap-10 text-[11px] font-bold uppercase tracking-[0.2em] text-coffee-cream/80">
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <a href="#" onClick={() => setIsMobileMenuOpen(false)} className="text-coffee-cream hover:text-coffee-tan transition-colors uppercase tracking-widest text-sm font-bold">Home</a>
